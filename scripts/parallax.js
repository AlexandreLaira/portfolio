...
function moveUp(e) {
  ...
  titulocentral.style.opacity = 1 - .003 * topDistance;
  paragrafoCentral.style.top = -1.03 * topDistance + "px";
  paragrafoCentral.style.opacity = 1 - .003 * topDistance;
  botaoIncial.style.top = -1.03 * topDistance + "px";
  botaoIncial.style.opacity = 1 - .003 * topDistance;
  ...
  if (topDistance < alturaTelaIncial + 100) {
    imagem.style.left = .3 * topDistance - 150 + "px";
    conteudo.style.right = .3 * topDistance - 350 + "px";
    imagem.style.opacity = 0 + .002 * topDistance;
    conteudo.style.opacity = 0 + .002 * topDistance;
  }
}
setTimeout(() => {
